...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A productivity platform for committed couples. Show up daily, unlock time together." },
      { name: "author", content: "TwoGether" },
      { property: "og:title", content: "TwoGether — Earn your time together" },
      { property: "og:description", content: "A productivity platform for committed couples. Show up daily, unlock time together." },
